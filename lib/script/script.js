...
Script.prototype.getData = function() {
  if (this.isDataOut() || this.isScriptHashOut()) {
    if (_.isUndefined(this.chunks[1])) {
      ...
      // Cater for OP_PUSH, etc
      return Buffer.concat(this.chunks.map((chunk) => {
        return (typeof chunk.buf !== 'undefined') ? Buffer.from(chunk.buf) : Buffer.alloc(0);
      }));
      
      // Does not cater to OP_PUSH, etc
