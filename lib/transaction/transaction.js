...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://libcash.io/api/lib/transaction#serialization-checks';
 ...
 * and a slightly fancier format recognized by libcash:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a libcash Address object. The
 * same is true for `script`, which can be a string or a libcash Script.
 *
