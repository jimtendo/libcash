...
To get started, just `npm install libcash` or `bower install libcash`.
...
- [Mnemonics](https://github.com/bitpay/libcash/tree/master/packages/libcash-mnemonic)
- [Elliptical Curve Integrated Encryption Scheme](https://github.com/bitpay/libcash-ecies)
...
var imported = libcash.PrivateKey.fromWIF(exported);
...
var p2shAddress = new libcash.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new libcash.URI(paymentInfo).toString();
```
