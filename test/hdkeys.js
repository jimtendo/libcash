...
var HDPrivateKey = libcash.HDPrivateKey;
var HDPublicKey = libcash.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = libcash.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(libcash.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(libcash.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      libcash.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = libcash.PublicKey.fromPoint;
      libcash.PublicKey.fromPoint = function() {
        libcash.PublicKey.fromPoint = unstubbed;
