...
var libcash = require('../..');
var BN = libcash.crypto.BN;
var Transaction = libcash.Transaction;
var Input = libcash.Transaction.Input;
var Output = libcash.Transaction.Output;
var PrivateKey = libcash.PrivateKey;
var Script = libcash.Script;
var Address = libcash.Address;
var Networks = libcash.Networks;
var Opcode = libcash.Opcode;
var errors = libcash.errors;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    ...
    tx.inputs[0].should.be.instanceof(libcash.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(libcash.Script);
